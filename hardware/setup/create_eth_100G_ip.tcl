...
update_ip_catalog -rebuild -scan_changes 
 ...
 # Create interface ports
  ...
  # Create instance: axis_clock_converter_rx_0, and set properties
  set axis_clock_converter_rx_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_clock_converter:1.1 axis_clock_converter_rx_0 ]
  ...
  connect_bd_intf_net -intf_net axis_clock_converter_rx_0_M_AXIS [get_bd_intf_pins axis_clock_converter_rx_0/M_AXIS] [get_bd_intf_pins axis_data_fifo_1/S_AXIS]
  ...
  connect_bd_intf_net -intf_net cmac_usplus_0_axis_rx [get_bd_intf_pins axis_clock_converter_rx_0/S_AXIS] [get_bd_intf_pins cmac_usplus_0/axis_rx]
  ...
  connect_bd_net -net cmac_usplus_0_gt_txusrclk2 [get_bd_pins axis_clock_converter_rx_0/s_axis_aclk] [get_bd_pins axis_clock_converter_tx_0/m_axis_aclk] [get_bd_pins cmac_usplus_0/gt_txusrclk2] [get_bd_pins cmac_usplus_0/rx_clk]
  ...
  connect_bd_net -net i_capi_clk_1 [get_bd_ports i_capi_clk] [get_bd_pins axis_clock_converter_rx_0/m_axis_aclk] [get_bd_pins axis_clock_converter_tx_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins cmac_usplus_0/drp_clk] [get_bd_pins cmac_usplus_0/init_clk]
  ...
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins axis_clock_converter_rx_0/m_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins util_vector_logic_1/Res]
  connect_bd_net -net util_vector_logic_2_Res [get_bd_pins axis_clock_converter_rx_0/s_axis_aresetn] [get_bd_pins util_vector_logic_2/Res]
